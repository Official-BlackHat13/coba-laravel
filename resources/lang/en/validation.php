    ...
    */
    ...
    'custom' => [
        'nama' => [
            ...
            'max' => 'Nama harus maksimal :max karakter'
        ],
        'name' => [
            'required' => 'Masukkan nama terlebih dahulu',
            'max' => 'Nama harus maksimal :max karakter'
        ...
        'jurusan' => [
            'required' => 'Pilih jenis jurusan terlebih dahulu'
        ],
        'kelas' => [
            'required' => 'Pilih kelas terlebih dahulu'
        ],
        'hp_number' => [
            'required' => 'Masukkan nomor telepon terlebih dahulu'
        ],
        'alamat' => [
        ...
        'password' => [
            ...
            'max' => 'Password harus maksimal :max karakter'
        ],
        'password2' => [
            'required' => 'Masukkan konfirmasi password terlebih dahulu',
            'same' => 'Password tidak sama'
        ],
        'username' => [
            'required' => 'Masukkan username terlebih dahulu',
            'unique' => 'Username sudah terdaftar',
            'max' => 'Username harus maksimal :max karakter'
        ]
    ],
